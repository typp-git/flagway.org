...
export async function EditPlayerModal({ playerData, onClose }: {playerData: Player, onClose:()=>void}) {
  ...
  <div className="fixed inset-0 flex flex-col justify-center items-center bg-gray-900/50 z-50">
    ...
    <div className="bg-white py-4 px-6">
      <form onSubmit={submitData} id="player-form">
        <div>
          <EditField label="First Name" name="first_name" defaultValue={playerData.first_name} type="text" form_id="player-form" onChange={(val)=>{console.log("val", val)}}/>
          <EditField
            label="Last Name"
            name="last_name" 
